...
#trenowanie:
my_classifier = KNeighborsClassifier(n_neighbors=5, algorithm='auto')
...
print("precision: " )
print( precision_score(y_test, y_out, pos_label="e"))
print("recall: " )
print(recall_score(y_test, y_out, pos_label="e"))
print("f1: " )
print(f1_score(y_test, y_out, pos_label="e"))
